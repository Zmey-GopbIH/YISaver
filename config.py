...
# ========== ADMIN SETTINGS ==========
ADMIN_IDS = [384368691]  # «амените на ваш Telegram ID
...
# ========== DEFAULT SETTINGS ==========
DEFAULT_MAX_SERVER_SIZE = 500 * 1024 * 1024  # 500MB - максимальный размер дл€ сервера
DEFAULT_MAX_CHAT_SIZE = 50 * 1024 * 1024  # 50MB - максимальный размер дл€ отправки в чат
